...
// gcc -Wall -o ex2 labaux.c ex2.c  -> esse comando faz de uma vez só: cria o objeto dos dois arquivos, compilando-os e depois une eles, tornando um unico arquivo que pode ser executado.
